    ...
    >
      ...
      <Link href={`/products/${product.id}`} className="block relative z-10">
        ...
        <div className="space-y-3">
          <h3 className={`font-semibold text-gray-900 line-clamp-1 transition-all duration-300 ${isHovered ? 'text-brand transform -translate-y-0.5' : ''}`}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 cursor-pointer ${isHovered ? 'bg-brand text-white scale-110 shadow-lg animate-glow' : 'bg-brand/10 text-brand hover:bg-brand hover:text-white'}`}>
