      ...
      const MOCK: any[] = [
        {
          ...
          description: 'Soft-baked cookie packed with big chocolate chunks and chips.',
          price: 3.5,
          currency: 'USD',
        ...
        {
          id: 'mock-2',
          name: 'Rainbow Candy Cookie',
          description: 'Buttery cookie loaded with colorful candy-coated chocolates.',
          price: 3.75,
          currency: 'USD',
        ...
        },
        {
          ...
          description: 'Vanilla cookie with white chocolate chips and a vanilla wafer.',
          price: 3.75,
          currency: 'USD',
        ...
        {
          id: 'mock-4',
          name: 'Cookies & Cream Brownie (Pan)',
          description: 'Fudgy brownie topped with sandwich cookie pieces.',
          price: 5.0,
          currency: 'USD',
        ...
        {
          id: 'mock-5',
          name: 'Chocolate Party Sheet Cake',
          description: 'Rich chocolate cake with chocolate frosting and candy sprinkles.',
          price: 6.0,
          currency: 'USD',
        ...
        {
          id: 'mock-6',
          name: 'Classic Fudge Brownie (Pan)',
          description: 'Glossy-top, extra-fudgy chocolate brownie.',
          price: 4.5,
          currency: 'USD',
        ...
        {
          id: 'mock-7',
          name: 'Lemon White Chocolate Cookie',
          description: 'Bright lemon cookie studded with white chocolate chips.',
          price: 3.5,
          currency: 'USD',
